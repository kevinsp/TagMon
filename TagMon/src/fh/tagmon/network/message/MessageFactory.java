...
public class MessageFactory {
	...
	public static MessageObject<Integer> 
			getHostMessage_GameStart(int playerID){
		return new MessageObject<Integer>(MessageType.GAME_START, playerID, -1);
	}
	
	//Client-Message-Builder
	public static MessageObject<ActionObject> getClientMessage_Action(ActionObject act, final int playerID){
		return new MessageObject<ActionObject>(MessageType.ACTION, act, playerID);
	}
	public static MessageObject<AnswerObject> getClientMessage_Answer(AnswerObject ans, final int playerID){
		return new MessageObject<AnswerObject>(MessageType.ANSWER, ans, playerID);
	}
	public static MessageObject<String> getClientMessage_GameStart(String playerName, final int playerID){
